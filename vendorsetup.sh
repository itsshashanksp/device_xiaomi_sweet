...
git clone --depth=1 https://github.com/itsshashanksp/device_xiaomi_sm6150-common.git -b u14-pixelstar device/xiaomi/sm6150-common
...
git clone --depth=1 https://gitlab.com/itsshashanksp/android_prebuilts_clang_host_linux-x86_clang-r536225.git -b 14.0 prebuilts/clang/host/linux-x86/clang-r536225
git clone --depth=1 https://github.com/itsshashanksp/hardware_xiaomi.git -b u14 hardware/xiaomi
git clone --depth=1 https://github.com/itsshashanksp/frameworks_native.git -b 14-qpr3 frameworks/native
